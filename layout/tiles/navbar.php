 ...
 */
?>
    <nav id="essential_felnavbar" role="navigation" class="moodle-has-zindex<?php echo ($oldnavbar) ? ' oldnavbar' : '';  echo ($haslogo) ? ' logo' : ' nologo';?>">
        <div class="navbar">
            <div class="container-fluid navbar-inner">
                <div class="row-fluid">
                    <div class="custommenus pull-<?php echo ($left) ? 'left' : 'right'; ?>">
                        <a class="btn btn-navbar" data-toggle="collapse" data-target="#essential_felmenus">
                    ...
                    <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>">
                        ...
                        <div id='essential_felmenus' class="nav-collapse collapse pull-<?php echo ($left) ? 'left' : 'right'; ?>">
