...
function theme_essential_fel_analytics_trackurl() {
    global $DB, $PAGE;
...
function theme_essential_fel_insert_analytics_tracking() {
    $siteurl = \theme_essential_fel\toolbox::get_setting('analyticssiteurl');
    $tracking = '';

    if (!empty($siteurl)) {
        $imagetrack = \theme_essential_fel\toolbox::get_setting('analyticsimagetrack');
        $siteid = \theme_essential_fel\toolbox::get_setting('analyticssiteid');
        $trackadmin = \theme_essential_fel\toolbox::get_setting('analyticstrackadmin');
        $useuserid = \theme_essential_fel\toolbox::get_setting('analyticsuseuserid');
        $cleanurl = \theme_essential_fel\toolbox::get_setting('analyticscleanurl');
        ...
        if ($cleanurl) {
            $doctitle = "".PHP_EOL."_paq.push(['setDocumentTitle', " . theme_essential_fel_analytics_trackurl() . "]);";
        } else {
            $doctitle = "";
        }
...
echo theme_essential_fel_insert_analytics_tracking();