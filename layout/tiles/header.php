...
<head>
    ...
    <?php require_once(\theme_essential_fel\toolbox::get_tile_file('iosicons')); ?>
    <!-- Start Analytics -->
...
<?php
echo local_print_administrator_message();
...
<?php
if (!$oldnavbar) {
    require_once(\theme_essential_fel\toolbox::get_tile_file('navbar'));
}
?>
...
<?php
if (!$haslogo) {
    $usesiteicon = \theme_essential_fel\toolbox::get_setting('usesiteicon');
    ...
    if ($usesiteicon || $headertitle) {
        ...
        echo '">';
        if ($usesiteicon) {
            echo '<span id="headerlogo" aria-hidden="true" class="fa fa-'.\theme_essential_fel\toolbox::get_setting('siteicon').'"></span>';
        }
        if ($headertitle) {
...
?>
                ...
                <a class="btn btn-icon collapsed" data-toggle="collapse" data-target="#essential_felicons">
                ...
                <div id='essential_felicons' class="collapse pull-<?php echo ($left) ? 'right' : 'left'; ?>">
<?php
}
...
?>
                        <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>" id="socialnetworks">
                            <p id="socialheading"><?php echo get_string('socialnetworks', 'theme_essential_fel') ?></p>
...
if ($hasmobileapps) { ?>
                        <div class="pull-<?php echo ($left) ? 'right' : 'left'; ?>" id="mobileapps">
                            <p id="socialheading"><?php echo get_string('mobileappsheading', 'theme_essential_fel') ?></p>
                            <ul class="socials unstyled">
                                <?php
