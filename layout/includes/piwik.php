...
{
    $imagetrack = theme_essential_fel_get_setting('analyticsimagetrack');
    $siteurl = theme_essential_fel_get_setting('analyticssiteurl');
    $siteid = theme_essential_fel_get_setting('analyticssiteid');
    $trackadmin = theme_essential_fel_get_setting('analyticstrackadmin');
    $cleanurl = theme_essential_fel_get_setting('analyticscleanurl');
    $tracking = '';
