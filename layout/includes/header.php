                ...
                echo (!$left) ? ' pull-right' : ' pull-left'; ?>">
                    <?php if (empty($haslogo)) { ?>
                        <a class="textlogo" href="<?php echo $CFG->wwwroot; ?>">
                            <i id="headerlogo" class="fa fa-<?php echo theme_essential_fel_get_setting('siteicon'); ?>"></i>
                            <?php echo theme_essential_fel_get_title('header'); ?>
                        </a>
                    <?php } else { ?>
            ...
            <div class="container-fluid navbar-inner">
                <div class="row-fluid">
                    <div class="custommenus pull-left">
                        ...
                        <?php echo theme_essential_fel_get_title('navbar'); ?>
