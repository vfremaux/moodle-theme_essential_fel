...
/**
 * Strings for component 'theme_essential_fel', language 'fr', branch 'MOODLE_25_STABLE'
 *
...
$string['backgroundcolordesc'] = 'Ici vous pouvez changer la couleur de l\'ensemble du fond de page.';
...
$string['donate_click'] = 'Cliquez pour faire un don';
...
$string['enablemarketingsecondrowdesc'] = 'si actif, une deuxième rangée d\'annonces marketing sera visible avec les définitions ci-dessous';
...
$string['themecolorlight'] = 'Couleur claire du thème';
$string['themecolorlightdesc'] = 'La couleur que votre thème devrait avoir dans les parties claires. Ceci va changer de multiples composants pour produire la couleur que vous souhaitez sur le site Moodle';
$string['themecolordark'] = 'Couleur sombre du thème';
$string['themecolordarkdesc'] = 'La couleur que votre thème devrait avoir dans les parties sombres. Ceci va changer de multiples composants pour produire la couleur que vous souhaitez sur le site Moodle';
$string['themeinfobgcolor'] = 'Couleur du fond de panneau d\'information';
$string['themeinfobgcolordesc'] = 'Définissez la couleur du fond des panneaux d\'information.';
$string['treeleafcolor'] = 'Couleur des éléments terminaux de la navigation';
$string['treeleafcolordesc'] = 'La couleur des "feuilles" de l\'arbre de navigation.';
