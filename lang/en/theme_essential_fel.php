...
$string['essential_fel:configure'] = 'Configure the theme';
$string['essential_fel:editfront'] = 'Edit front page items';
...
<div class="clearfix">
<div class="well">
<h2>Essential Formation En Ligne</h2>
<p><img class="img-polaroid" src="essential_fel/pix/screenshot.jpg" /></p>
</div>
<div class="well">
...
$string['region-main'] = 'Main page region';
...
$string['backgroundcolordesc'] = 'Set the color for the whole page background.';
...
$string['themecolorlight'] = 'Theme colour light';
$string['themecolorlightdesc'] = 'What colour should your theme be in its light parts.  This will change multiple components to produce the colour you wish across the Moodle site';

$string['themecolordark'] = 'Theme colour dark';
$string['themecolordarkdesc'] = 'What colour should your theme be in its darks parts.  This will change multiple components to produce the colour you wish across the Moodle site';

$string['themeinfobgcolor'] = 'Theme information panel background color';
$string['themeinfobgcolordesc'] = 'What colour should your theme be in the info panels.  This will change multiple components to produce the colour you wish across the Moodle site';

$string['treeleafcolor'] = 'Navigation tree leaf color';
$string['treeleafcolordesc'] = 'What colour should the leaf items of the navigatoin tree have.';
...
$string['marketingsecondrow'] = 'Marketing second row';
$string['enablemarketingsecondrow'] = 'enable second row';
$string['enablemarketingsecondrowdesc'] = 'If enable uses a second row with following definitions';
...
$string['uploadusers'] = 'Importer users';
