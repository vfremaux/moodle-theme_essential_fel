...
if (!array_key_exists('configtitle', $string)) {
    ...
    <div class="well">
    <h2>Essential</h2>
    <p><img class="img-polaroid" src="essential_fel/pix/screenshot.jpg" alt="Essential screen shot"/></p>
    </div>
    <div class="well">
    <h3>About Essential FEL</h3>
    ...
    <p>
    <h3>Essential FEL for Moodle 3.0 kindly sponsored by:</h3>
    <ul>
    <li>Leila Hiret</li>
...
$string['additionalcsssheets'] = 'Additional CSS sheets';
$string['additionalcsssheetsdesc'] = 'A list of contextual sheet names that should be loaded in this moodle instance.';
...
$string['footerlogodesc'] = 'Some logo file.';
...
$string['styleguidedesc'] = 'Original documentation code \'{$a->origcodelicenseurl}\' licensed.  Holder.js is \'{$a->holderlicenseurl}\' licensed.  Additional code \'{$a->thiscodelicenseurl}\' licensed, which is a \'{$a->compatible}\' license.  Content \'{$a->contentlicenseurl}\' licensed.  The documentation has been formatted for Moodle output with addition of FontAwesome icons where appropriate.  Additional CSS can be found in the file \'essential_fel_admin_setting_styleguide.php\' under the comment \'// Beyond docs.css.\'.  The \'{$a->globalsettings}\' section has been removed.';
...
// essential_fel_admin_setting_configinteger.
...
$string['uploadusers'] = 'Import user accounts';
$string['technical'] = 'Technical actions';

// Essential extra features (global scope).
$string['extras'] = 'Extras';
$string['editmodthumb'] = 'Update the module instance thumb';
$string['modthumb'] = 'Module instance thumb';
$string['cleanthumb'] = 'Delete the thumb image';
$string['modfixedthumbwidth'] = 'Activity/resource fixed thumb width';
$string['modfixedthumbwidthdesc'] = 'If set to a positive integer between 1 to 100, will defined the fixed width of the activity thumb column';
$string['hidelogoutlinks'] = 'Hide logout links';
$string['hidelogoutlinksdesc'] = 'In case moodle is used as sub application in an ENT, will hide all logout links';
...
$string['variantsheading_desc'] = 'Go to this additional screen to <a href="/theme/essential_fel/themecopy.php">clone variant settings.</a>';
...
$string['reset'] = 'Reset';
$string['showactivitynames'] = 'Show activity names';
$string['hideactivitynames'] = 'Hide activity names';
...
$string['returntoquiz'] = 'Back to quiz';
