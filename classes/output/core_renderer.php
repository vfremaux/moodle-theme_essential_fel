...
require_once($CFG->dirroot.'/theme/essential_fel/Mobile_Detect.php');
...
class core_renderer extends \core_renderer {
    ...
    protected $essential_fel = null; // Used for determining if this is a Essential or child of renderer.

    protected $themename = 'essential_fel';
    ...
    protected static function get_local_setting($setting, $format = '') {
    ...
    public function navbar() {
        ...
        if ($breadcrumbstyle) {
            ...
            if (($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse')) {
                $showcategories = self::get_local_setting('categoryincoursebreadcrumbfeature');
            }
    ...
    public function footer() {
        ...
        if (defined('MDL_PERF') || (!empty($CFG->perfdebug) and $CFG->perfdebug > 7)) {
            ...
            if (defined('MDL_PERFTOFOOT') || debugging() || $CFG->perfdebug > 7) {
                $performanceinfo = $this->performance_output($perf, self::get_local_setting('perfinfo'));
            }
        }
        ...
        return $button.$output.$footer.$info.$perfreport;
    }
    ...
    public function heading($text, $level = 2, $classes = null, $id = null) {
        ...
        if (($level == 2) && ($this->page->pagelayout == 'incourse') && (is_object($this->page->cm)) &&
            (self::get_local_setting('returntosectionfeature'))) {
            static $called = false;
            if (!$called) {
    ...
    public function course_content_header($onlyifnotcalledbefore = false) {
        ...
        if ($this->page->pagelayout == 'mydashboard') {
            if (\theme_essential_fel\toolbox::course_content_search()) {
                ...
                $content .= '<div><p>'.get_string('findcoursecontent', 'theme_essential_fel').'</p></div>';
        ...
        if ($currentcatid) {
            ...
            if ($image) {
                ...
                if ($imageurl) {
                    ...
                    $parents = \theme_essential_fel\toolbox::get_categories_list()[$currentcatid]->parents;
    ...
    protected function return_to_section() {
        ...
        if ($markup === null) {
            ...
            if ($sectionnamelen !== false) {
                $sectionnamelimit = self::get_local_setting('returntosectiontextlimitfeature');
            ...
            $title = get_string('returntosection', 'theme_essential_fel', array('section' => $sectionname));
    ...
    */
            ...
            if ($matches[1] === '') {
                ...
                if ($matches[1] == '0') {
                    ...
                    if (preg_match('/^user:(.*?)(=|~)(.*)$/', $condition, $matches)) {
                        ...
                        return str_replace('&amp;', '&', preg_replace('/^'.$condition.'!/', '', $url));
    ...
    public function custom_menu_courses() {
        ...
        $hasdisplaymycourses = self::get_local_setting('displaymycourses');
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            $mycoursesorder = self::get_local_setting('mycoursesorder');
            if (!$mycoursesorder) {
                $mycoursesorder = 1;
            }
            ...
            $mycoursetitle = self::get_local_setting('mycoursetitle');
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('my'.$lateststring.'modules', 'theme_essential_fel');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('my'.$lateststring.'units', 'theme_essential_fel');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('my'.$lateststring.'classes', 'theme_essential_fel');
            } else {
                $branchtitle = get_string('my'.$lateststring.'courses', 'theme_essential_fel');
            }
            ...
            $numcourses = 0;
            $hasdisplayhiddenmycourses = self::get_local_setting('displayhiddenmycourses');
            ...
            if (($mycoursesorder == 1) || ($mycoursesorder == 2)) {
                ...
                if ($mycoursesorder == 1) {
                    ...
                    $sortorder = 'id';
                    $mycoursesorderidorder = self::get_local_setting('mycoursesorderidorder');
            ...
            if ($courses) {
                $mycoursesmax = self::get_local_setting('mycoursesmax');
                if (!$mycoursesmax) {
    ...
    public function custom_menu_themecolours() {
        ...
        if (!isguestuser()) {
            ...
            foreach (range(1, 4) as $alternativethemenumber) {
                if (self::get_local_setting('enablealternativethemecolors' . $alternativethemenumber)) {
            ...
            if (!empty($alternativethemes)) {
                ...
                foreach ($alternativethemes as $alternativethemenumber) {
                    if (self::get_local_setting('alternativethemename' . $alternativethemenumber)) {
                        $alternativethemeslabel = self::get_local_setting(
                    ...
                    $branch->add($this->getfontawesomemarkup('square', array('colours-alternative'.$alternativethemenumber)).
                        ...
                        new moodle_url($this->page->url, array('essential_felcolours' => 'alternative' . $alternativethemenumber)),
                            $alternativethemeslabel);
                }
            }
        }
    ...
    public function custom_menu_activitystream() {
        if (!isguestuser()) {
            if ((($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse') ||
                ...
                $branchtitle = get_string('thiscourse', 'theme_essential_fel');
                ...
                $branchtitle = get_string('people', 'theme_essential_fel');
    ...
    public function custom_menu_goto_bottom() {
        ...
        if (($this->page->pagelayout == 'course') || ($this->page->pagelayout == 'incourse') ||
            ...
            $menu->add($gotobottom, new moodle_url('#region-main'), get_string('gotobottom', 'theme_essential_fel'));
    ...
    public function custom_menu_editing() {
        $html = '';
        if (self::get_local_setting('displayeditingmenu')) {
            if ($this->page->user_allowed_editing()) {
                ...
                if ($buttontoadd) {
                    ...
                    if (self::get_local_setting('hidedefaulteditingbutton')) {
    ...
    protected function render_user_picture(\user_picture $userpicture) {
        if ($this->page->pagetype == 'mod-forum-discuss') {
            $userpicture->size = 1;
        } else if ((empty($userpicture->size))) {
            $userpicture->size = 72;
        }
        ...
        if (!isloggedin()) {
            ...
            if (\core\session\manager::is_loggedinas()) {
                ...
                $branchlabel = '<em>'.$this->getfontawesomemarkup('key').fullname($realuser, true).
                    get_string('loggedinas', 'theme_essential_fel').fullname($USER, true).'</em>';
            } else {
            ...
            if (is_mnet_remote_user($USER) && $idprovider = $DB->get_record('mnet_host', array('id' => $USER->mnethostid))) {
                $branchlabel = '<em>'.$this->getfontawesomemarkup('users').get_string('loggedinfrom', 'theme_essential_fel').
                    $idprovider->name.'</em>';
            ...
            if ($course->id == SITEID) {
                $branchlabel = '<em>'.$this->getfontawesomemarkup('list-alt').get_string('mygrades', 'theme_essential_fel').'</em>';
                ...
                if (has_capability('gradereport/user:view', $context) && $course->showgrades) {
                    ...
                    $branchlabel = '<em>'.$this->getfontawesomemarkup('list-alt').
                        get_string('coursegrades', 'theme_essential_fel').'</em>';
            ...
            $hidelogoutlinks = get_config('theme_essential_fel', 'hide_logout_links');
            if (empty($hidelogoutlinks) || ($USER->auth == 'manual')) {
    ...
    protected function theme_essential_fel_render_helplink() {
        global $USER, $CFG;
        if (!self::get_local_setting('helplinktype')) {
            return false;
        }
        ...
        if (self::get_local_setting('helplinktype') === '1') {
            if (self::get_local_setting('helplink') &&
                    filter_var(self::get_local_setting('helplink'), FILTER_VALIDATE_EMAIL)) {
                $branchurl = 'mailto:' . self::get_local_setting('helplink').'?cc='.$USER->email;
                ...
                $branchurl = preg_replace("(https?:)", "", $CFG->wwwroot).'/admin/settings.php?section=theme_'.$this->themename.'_header';
                $branchlabel = '<em>'.$this->getfontawesomemarkup('exclamation-triangle', array('red')).
                    get_string('invalidemail').'</em>';
            }
        }

        if (self::get_local_setting('helplinktype') === '2') {
            if (self::get_local_setting('helplink') &&
                    filter_var(self::get_local_setting('helplink'),
                        FILTER_VALIDATE_URL, FILTER_FLAG_SCHEME_REQUIRED)) {
                $branchurl = self::get_local_setting('helplink');
                $target = '_blank';
            } else if ((!self::get_local_setting('helplink')) &&
    ...
    protected function theme_essential_fel_render_preferences($context) {
        ...
        if (!empty($CFG->enablebadges) && has_capability('moodle/badges:manageownbadges', $context)) {
            $branchlabel = '<em>'.$this->getfontawesomemarkup('certificate').
                get_string('badgepreferences', 'theme_essential_fel').'</em>';
        ...
        if (is_dir($CFG->dirroot.'/local/userequipment')) {
            ...
            if (!empty($config->enabled) && local_ue_has_capability_somewhere('local/userequipment:selfequip', false, false, true)) {
    ...
    */
    ...
    public function render_social_network($socialnetwork) {
        if (self::get_local_setting($socialnetwork)) {
            $icon = $socialnetwork;
            ...
            $socialnetworklabel = get_string($socialnetwork, 'theme_essential_fel');
            $socialhtml .= html_writer::start_tag('button', array('type' => "button",
                'class' => 'socialicon ' . $socialnetwork,
                'onclick' => "window.open('".self::get_local_setting($socialnetwork)."')",
     ...
     * @return string HTML.
     */
    public function essential_fel_blocks($region, $classes = array(), $tag = 'aside', $blocksperrowsetting = false) {
        if ($this->page->blocks->is_known_region($region)) {
            ...
            if ($blocksperrowsetting !== false) {
                if (is_int($blocksperrowsetting)) {
                    ...
                    $blocksperrow = self::get_local_setting($blocksperrowsetting);
                }
            } else {
                $blocksperrow = false;
            }
            ...
            if ($editing) {
                $regioncontent .= html_writer::tag('span', html_writer::tag('span', get_string('region-'.$region, 'theme_essential_fel')),
            ...
            if ($this->page->blocks->region_has_content($region, $this)) {
                if ($blocksperrow !== false) {
                    ...
                    $regioncontent .= $this->essential_fel_blocks_for_region($region, $blocksperrow, $editing);
     ...
     */
    protected function essential_fel_blocks_for_region($region, $blocksperrow, $editing) {
    ...
    public function standard_footer_html() {
        ...
        $output .= html_writer::start_tag('div', array ('class' => 'themecredit')).
            get_string('credit', 'theme_essential_fel',
            array('name' => html_writer::link('https://moodle.org/plugins/theme_essential_fel', 'Essential', array('target' => '_blank')))).
    ...
    public function essential_fel_marketing_button($spot) {
        $o = '';
        $url = self::get_local_setting('marketing'.$spot.'buttonurl');
        if (!empty($url)) {
            $url = '<a href="'.$url.'" ';
            $url .= 'target="'.self::get_local_setting('marketing'.$spot.'target').'" class="marketing-button">';
            $url .= self::get_local_setting('marketing'.$spot.'buttontext', true);
            $url .= '</a>';
        }
        $edit = $this->essential_fel_edit_button('frontpage');
     ...
     *
     * Ensure that the 'essential_fel_edit_button_settingspage' method has the 'keys' and values for the sections
     ...
     */
    public function essential_fel_edit_button($sectionkey, $buttontext = null) {
        global $CFG;
        if ($this->page->user_is_editing() && is_siteadmin()) {
            $themesectionkey = $this->essential_fel_edit_button_settingspage($sectionkey);
     ...
     * call the 'essential_fel_edit_button' method for.
     *
     * @param string $sectionkey settings section key.
     * @return string or false if not found.
     */
    protected function essential_fel_edit_button_settingspage($sectionkey) {
        $themesectionkey = false;

        switch ($sectionkey) {
            case 'frontpage':
                $themesectionkey = 'theme_essential_fel_frontpage';
            break;
            case 'footer':
                $themesectionkey = 'theme_essential_fel_footer';
            break;
            case 'slideshow':
                $themesectionkey = 'theme_essential_fel_slideshow';
            break;
        }
    ...
    public function get_title($location) {
        ...
        if ($location === 'navbar') {
            ...
            switch (self::get_local_setting('navbartitle')) {
                case 0:
                    return false;
                break;
                case 1:
            ...
            switch (self::get_local_setting('headertitle')) {
                case 0:
                    return false;
                    break;
                case 1:
        ...
        if ($perfinfo === "max") {
            ...
            if ($colcountmax != 0) {
                ...
                if (isset($param['cachesused'])) {
                    ...
                    $html .= html_writer::span(get_string('cachesused', 'theme_essential_fel'));
                    $html .= html_writer::end_tag('div');
                }
                if (isset($param['sessionsize'])) {
                    $html .= html_writer::start_tag('div', array('class' => 'span'.$thespanmax));
                ...
                if (isset($param['dbtime'])) {
                    ...
                    $html .= html_writer::span(get_string('dbtime', 'theme_essential_fel'));
                    $html .= html_writer::end_tag('div');
                }
            }
            $html .= html_writer::end_tag('div');
    ...
    public function version_alert() {
        ...
        if (($CFG->version < 2016052300.00) || ($CFG->version >= 2016111400.00)) {
            ...
            $result .= '<span class="title">'.get_string('versionalerttitle', 'theme_essential_fel').'</span><br />'.
                get_string('versionalerttext1', 'theme_essential_fel').'<br />'.
