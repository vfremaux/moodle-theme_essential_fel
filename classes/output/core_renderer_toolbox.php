...
namespace theme_essential_fel\output;
...
trait core_renderer_toolbox {
    ...
    public function get_tile_file($filename) {
        ...
        if (file_exists("$CFG->dirroot/theme/essential_fel/layout/tiles/$filename")) {
            return "$CFG->dirroot/theme/essential_fel/layout/tiles/$filename";
        } else if (!empty($CFG->themedir) and file_exists("$CFG->themedir/essential_fel/layout/tiles/$filename")) {
            return "$CFG->themedir/essential_fel/layout/tiles/$filename";
        } else {
