...
$thispageurl = new moodle_url('/theme/essential_fel/pages/styleguide.php');
...
$title = get_string('styleguide', 'theme_essential_fel');
$setting = new essential_fel_admin_setting_styleguide('theme_essential_fel_styleguide',
