 ...
 */
class essential_fel_admin_setting_styleguide extends admin_setting {
    ...
    public function __construct($name, $visiblename, $description) {
        ...
        if (($PAGE->bodyid == 'page-admin-setting-' . $name) ||
            ...
            $bc->title = get_string('styleguide', 'theme_essential_fel');
            ...
            $PAGE->requires->js_call_amd('theme_essential_fel/styleguide', 'init');
        }
